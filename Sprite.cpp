...
void Sprite::Initialize(SpriteBase* spBase)
{
...
void Sprite::Update()
{
	...
	// 1枚目の三角形
	vertexData[indexData[0]].position = { 0.0f, 360.0f, 0.0f, 1.0f };// 左下
